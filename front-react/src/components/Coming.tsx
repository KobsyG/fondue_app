    ...
    return (
        <div className='coming absolute top-0 left-0 h-[100vh] w-[100vw] bg-[#1B133B] flex flex-col overflow-hidden'>
            <div className='topbar w-full h-[20%] min-h-[180px] flex'>
                ...
                <div className='devenez h-full flex-col justify-center items-left hidden xl:flex ml-[30px] 1700:ml-[100px] text-[18px] 1600:text-[23px] 1800:text-[27px]'>
            ...
            <div className='main grow w-full flex items-end'>
                ...
                <div className='page3 relative h-full w-[35vw] macBeco:w-[40vw] min-w-[600px] macBeco:min-w-[750px] flex flex-col-reverse bg-yellow-800'>

                    <div className='ruban absolute h-[75%] w-[80px] macBeco:w-[100px] top-0 -left-[40px] macBeco:-left-[50px] bg-fondue-red'>
                    ...
                    <div className='flex items-end'>
                        ...
                        <div className='reseaux h-[60px] w-[115px] macBeco:w-[140px] flex justify-between mb-5 macBeco:mb-10'>
                            <button className='facebook macBeco:h-[60px] w-[50px] macBeco:w-[60px]'>
                                <img src={require('../images/waiting/facebook.webp')} />
                            </button>

                            <button className='instagram macBeco:h-[60px] w-[50px] macBeco:w-[60px]'>
