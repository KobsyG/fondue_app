        ...
        <div>
            <div className='terroir-wrap w-full h-[290vh] relative rounded-tr-[4rem]'>
                ...
                <div className='montagne-wrap w-full h-[100vh] sticky top-0'>
                    <img className='object-cover w-full h-full rounded-tr-[4rem]' src={require("../../images/montagne-gentiane.jpg")} />
                </div>
                ...
                <div className='livret h-[100vh] w-full relative top-0'>
                    <img className='object-contain absolute h-[100vh] right-0 rounded-tr-[4rem]' src={require("../../images/page-livret.png")} />
                </div>
